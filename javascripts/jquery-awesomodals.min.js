...
function(t, e, n, o) {
    ...
    function l(e, n) {
        this.element = e,
        this._name = i,
        this._defaults = t.fn[i].defaults,
    ...
    t.extend(l.prototype, {
        ...
        bindEvents: function() {
            var e = this;
            e.$element.on("click." + e._name, e.options.selectorOpen,
            function(n) {
                e.modalOpen.call(e, t(this))
            }).on("click." + e._name, e.options.selectorClose,
            function(n) {
                e.modalClose.call(e, t(this))
            }).on("click." + e._name, e.options.itemOverlay,
            function(n) {
                e.options.optionOverlayActive && e.modalClose.call(e, t(this))
            })
        },
        ...
        modalOpen: function(e) {
            ...
            this.debug("Modal ID: " + e.attr("data-modal")),
            event.preventDefault();
            var n = t(e.attr("data-modal"));
    ...
    t.fn[i] = function(e) {
        return this.each(function() {
            t.data(this, "plugin_" + i) || t.data(this, "plugin_" + i, new l(this, e))
        }),
        this
    },
    t.fn[i].defaults = {
